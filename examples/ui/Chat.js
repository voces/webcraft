...
class Chat {
	...
	_elementConstructor() {
		...
		this.input.placeholder = "Press enter to begin chatting.";
...
if ( isBrowser ) {
	...
	style.textContent = `
		...
		.wc.ui.chat:hover .history-container { -webkit-mask-image: none; }
		...
		.wc.ui.chat input:focus::-webkit-input-placeholder { color: transparent;  }`;
