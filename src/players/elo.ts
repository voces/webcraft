...
const calculatePower = ( team: number[] ) => team.reduce( ( sum, player ) =>
...
const calculateNewRatings = ( teamA: number[], teamB: number[], score: number ) => {
...
export default ( { mode, crossers, defenders, scores }: {mode: keyof Player["score"], crossers: Player[], defenders: Player[], scores: number} ): void => {
