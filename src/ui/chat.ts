...
const chatInputSuggestion = <HTMLInputElement>document.getElementById( "chat-input-suggestion" );
...
export const registerCommand = ( { name, aliases, args, comment, handler }: Command ): void => {
