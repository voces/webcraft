...
declare class DragSelect<T> {
    ...
    callback: (selected: Array<T>, event: MouseEvent | TouchEvent) => void;
    area: T | Document;
    ...
    constructor(options?: Partial<{
        ...
        onDragStartBegin: (event: MouseEvent | TouchEvent) => void;
        onElementSelect: (selected: T) => void;
        onElementUnselect: (selected: T) => void;
        selectableClass: string;
        selectables: ArrayLike<T> | T;
        selectedClass: string;
        selector: HTMLElement;
     ...
     * @return item
     */
    select(item: T): T | false;
    /**
     * Removes an item from the selection.
     * @param item selected item.
     * @return item
     */
    unselect(item: T): T | false;
    /**
     ...
     * @return cursor { x/y }
     */
    getCursorPos(event?: MouseEvent | TouchEvent, _area?: T | false, ignoreScroll?: boolean): {
        x: number;
        y: number;
    };
    /**
     ...
     */
    clearSelection(triggerCallback?: boolean): Array<T>;
    /**
     ...
     */
    addSelectables(_nodes: ArrayLike<T>, addToSelection?: boolean): Array<T>;
    /**
     * Gets all nodes that can be selected
     * @return this.selectables
     */
    getSelectables(): Array<T>;
    /**
